...
<template>
    ...
    <VFilter align="right" @apply="applyFilter" @clear="clearFilter">
        <div class="flex">
            <div class="pt-1.5 pb-4 px-4 w-2/6">
                <div class="text-xs font-semibold text-slate-400 uppercase mb-2">Sort By Minimum Value</div>
                <VRadio name="minimum-value" v-model="filter.minimum_value" :options="minimumValueOptions" />
            </div>
            <div class="pt-1.5 pb-4 px-4 w-2/6">
            ...
            <div class="pt-1.5 pb-4 px-4 w-2/6">
                <div class="text-xs font-semibold text-slate-400 uppercase mb-2">Filter by Status</div>
                <VCheckbox v-model="filter.active_status" label="Active" />
                <VCheckbox v-model="filter.inactive_status" label="Inactive" />
            </div>
        </div>
    </VFilter>
</template>