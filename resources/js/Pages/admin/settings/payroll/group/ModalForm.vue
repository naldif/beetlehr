...
const createHandle = async () => {
    ...
    axios.post(route('settings.payroll.group.create'), form.value)
        .then((res) => {
            emit('close')
            emit('successSubmit')
            form.value = ref({})
...
const updateHandle = async () => {
    isLoading.value = true
    axios.put(route('settings.payroll.group.update', { 'id': props.data.id }), form.value)
        .then((res) => {
            emit('close')
            emit('successSubmit')
            form.value = ref({})
...
<template>
    <VDialog :showModal="openDialog" :title="updateAction ? 'Update Payroll Group' : 'Add Payroll Group'"
