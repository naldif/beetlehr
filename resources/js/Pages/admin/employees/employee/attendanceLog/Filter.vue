...
<template>
    <!-- Search -->
    <!-- <VInput placeholder="Search by date" is-prefix v-model="searchValue" @update:model-value="search">
    ...
    <VFilter align="right" @apply="applyFilter" @clear="clearFilter">
        <div class="grid grid-cols-1 gap-3 px-4 pb-4 pt-1.5">
            <div>
                <div class="text-xs font-semibold text-slate-400 uppercase mb-1 uppercase">Filter by Status</div>
                <VSelect placeholder="Choose Status" v-model="filter.filter_status" :options="statusOptions"/>
            </div>
        </div>
    </VFilter>
</template>