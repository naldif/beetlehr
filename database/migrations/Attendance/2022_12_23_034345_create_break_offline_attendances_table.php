...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('break_offline_attendances', function (Blueprint $table) {
            $table->id();
            $table->foreignId('attendance_offline_log_id')->constrained('attendance_offline_logs')->cascadeOnUpdate()->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('break_offline_attendances');
    }
};
